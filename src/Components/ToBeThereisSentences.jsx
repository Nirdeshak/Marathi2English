...
import { ThereIsArePresentData } from "../Data/ThereIsArePresentData";

export default function ThereIsArePresentSentences() {
  ...
  const fetchSentences = () => {
    setLoading(true);
      try {
      let parsed = ThereIsArePresentData;
  ...
  const goBackWithScore = () => {
    const category = "There Is/Are Sentences";
