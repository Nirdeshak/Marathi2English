...
import { HaveHasPresentData } from "../Data/HaveHasPresentData";

export default function HaveHasPresentSentences() {
  ...
  const goBackWithScore = () => {
    const category = "Have/Has Sentences";
