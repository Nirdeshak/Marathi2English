...
import { SimpleFutureData } from "../Data/SimpleFutureData";


export default function SimpleFutureSentences() {
  ...
  const goBackWithScore = () => {
    const category = "Simple Future Sentences";
