...
import { ThereIsAreFutureData } from "../Data/ThereIsAreFutureData";


export default function ThereIsAreFutureSentences() {
  ...
  const fetchSentences = () => {
    setLoading(true);
      try {
      let parsed = ThereIsAreFutureData;
  ...
  const goBackWithScore = () => {
    const category = "There Is/Are Future Sentences";
