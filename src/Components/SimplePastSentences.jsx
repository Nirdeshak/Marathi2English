...
import { SimplePastData } from "../Data/SimplePastData";

export default function SimplePastSentences() {
  ...
  const goBackWithScore = () => {
    const category = "Simple Past Sentences";
