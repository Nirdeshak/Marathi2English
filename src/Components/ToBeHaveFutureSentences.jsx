...
import { HaveHasFutureData } from "../Data/HaveHasFutureData";


export default function HaveHasFutureSentences() {
  ...
  const goBackWithScore = () => {
    const category = "Have/Has Future Sentences";
