...
import { SimplePresentData } from "../Data/SimplePresentData";

export default function SimplePresentSentences() {
  ...
  const goBackWithScore = () => {
    const category = "Simple Present Sentences";
