...
import { HaveHasPastData } from "../Data/HaveHasPastData";

export default function HaveHasPastSentences() {
  ...
  const goBackWithScore = () => {
    const category = "Have/Has Past Sentences";
