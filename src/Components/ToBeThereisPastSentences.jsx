...
import { ThereIsArePastData } from "../Data/ThereIsArePastData";

export default function ThereIsArePastSentences() {
  ...
  const goBackWithScore = () => {
    const category = "There Is/Are Past Sentences";
