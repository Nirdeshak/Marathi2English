...
import { PresentContinuousData } from "../Data/PresentContinuousData";

export default function PresentContinuousSentences() {
  ...
  const fetchSentences = () => {
    setLoading(true);
      try {
      let parsed = PresentContinuousData;
  ...
  const goBackWithScore = () => {
    const category = "Present Continuous Sentences";
